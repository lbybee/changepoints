...
# basic tests to determine if the methods are working for the GGM
# case, NOTE these do not confirm that the results are correct, these
# are just tests to confirm that nothing broken
t_data <- rnorm(1000)
